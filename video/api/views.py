...
class VideoCreateAPi(CreateAPIView):
    ...
    def perform_create(self, serializer):
        ...
        charges=0
        video = moviepy.editor.VideoFileClip("/home/suren/Desktop/suren/assignment/media/video/LAURE_Ft._AIDRAY-ROHIT_SHAKYA_-_Dui_Rupaiyan_OFFICIAL_MOVIE_SONG1_a0ShdOb.mp4")
